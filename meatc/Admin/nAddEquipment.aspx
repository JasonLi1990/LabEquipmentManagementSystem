<%@ Page Language="C#" MasterPageFile="~/Admin/A_MasterPage.master" AutoEventWireup="true" CodeFile="nAddEquipment.aspx.cs" Inherits="Admin_nAddEquipment" Title="无标题页" %>
       ...
       <table width=90% cellpadding="0" cellspacing="0" class="blue">
           ...
           <tr>
               ...
               <td>
                   &nbsp;</td>
                    <td align=left>
                        <asp:DropDownList ID="ddlEquipmentManager" runat="server" Width="156px">
                        </asp:DropDownList>
               </td>
                <td align=right class="blue">
                    设备型号</td>
