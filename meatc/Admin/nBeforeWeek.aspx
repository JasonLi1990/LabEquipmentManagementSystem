<%@ Page Language="C#" MasterPageFile="~/Admin/A_MasterPage.master" AutoEventWireup="true" CodeFile="nBeforeWeek.aspx.cs" Inherits="Admin_nBeforeWeek" Title="无标题页" %>
...
<table width=100% cellpadding=0 cellspacing=0 border=0>
   ...
   <td height="45px" valign=bottom align=left style="background:url(../Images/Contentback01.png); background-repeat:repeat-x;" nowrap>
       ...
       <td width=150px align=right valign=bottom> 
           <asp:Image ID="ImgTitle" runat="server" ImageUrl="~/Images/Btn02WeekPlanSummary.png"/>
   ...
   <tr>
   <td valign=top>
      <asp:Panel ID="Panel1" runat="server" Width="100%" Height="500px" Visible="true" ScrollBars="Auto">
