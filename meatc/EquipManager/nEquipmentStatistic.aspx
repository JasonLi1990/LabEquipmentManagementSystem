<%@ Page Language="C#" MasterPageFile="~/EquipManager/EM_MasterPage.master" AutoEventWireup="true" CodeFile="nEquipmentStatistic.aspx.cs" Inherits="EquipManager_nEquipmentStatistic" Title="无标题页" %>
       ...
       <asp:GridView ID="GVFaultEquipment" runat="server" AutoGenerateColumns="False" HeaderStyle-HorizontalAlign="Center" 
           ...
           <Columns>
               <asp:HyperLinkField HeaderText="设备名称" ControlStyle-CssClass="blue" 
                   ...
                   DataNavigateUrlFormatString="nHowToUserEquip.aspx?e_id={0}" >
