<%@ Page Language="C#" MasterPageFile="~/EquipManager/EM_MasterPage.master" AutoEventWireup="true" CodeFile="nOnlineMessage.aspx.cs" Inherits="EquipManager_nOnlineMessage" Title="无标题页" %>
...
<center>
<asp:Panel ID="panelEquipmentList" runat="server" CssClass="f1" Visible="false" Style="position:absolute;
    ...
    <asp:Panel ID="panel_reply" runat="server" CssClass="f1" Visible="false" Style="position:absolute;
        width: 300px; height: 200px; z-index: 100; top: 185px; left: 284px; background-color: White; border:solid">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <asp:TextBox ID="tb_message_new" runat="server" Width="560px"></asp:TextBox>
    <asp:Button ID="bt_sendMessage" runat="server" Text="发送消息" 
        onclick="bt_sendMessage_Click" />
        <hr />
<asp:Repeater ID="rp_msg" runat="server" onitemcommand="rp_msg_ItemCommand">
    <ItemTemplate>
        <table width="600px" border="1" class="f1">
            <tr>
                <td>
                    ...
                    <%# Eval("UserType").ToString().Equals("3") ? "（管理员）" : "（学生/教师）"%>
                </td>
                <td align="right">
                    发送时间：
