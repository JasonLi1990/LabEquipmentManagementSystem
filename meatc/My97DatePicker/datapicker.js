...
document.write('<select id="selTianMinute" style="'+s_tiannet_select2+'display:none;" Author="tiannet" '+
    ...
    'this.style.display=\'none\';">');
    document.writeln('<option value="00">00分</option>');
    document.writeln('<option value="15">15分</option>');
    document.writeln('<option value="30">30分</option>');
    document.writeln('<option value="45">45分</option>');
    //for(var i=0;i <= 59;i ++){
