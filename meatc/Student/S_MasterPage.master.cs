...
public partial class Student_S_MasterPage : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        this.Page.Title = "欢迎使用哈尔滨工业大学市政环境工程学院网上预约系统 ------  学生登录中";        
        if (!IsPostBack)
        {
            BindNotes();
            BindSelfInfo();
    ...
    private void BindNotes()
    {
        ...
        {
            lblUserType.Text = "校外用户";
        }
        else if (UserType.Equals("5"))
        {
            lblUserType.Text = "本校用户";
        }
