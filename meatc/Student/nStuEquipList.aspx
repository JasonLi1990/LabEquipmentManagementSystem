<%@ Page Language="C#" MasterPageFile="~/Student/S_MasterPage.master" AutoEventWireup="true" CodeFile="nStuEquipList.aspx.cs" Inherits="Student_nStuEquipList" Title="无标题页" %>
...
<asp:Panel ID="panelEquipmentList" runat="server" Visible="false" Style="position: absolute;
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" height="500px">
        <tr>
            <td  valign="top" align="left" style="background: url(../Images/Contentback01.png);">
                <table width="100%">
                    <tr>
                        ...
                        <td align="right" valign="bottom">
                            设备名称：<asp:TextBox ID="tb_equipName" runat="server"></asp:TextBox>
        ...
        <tr>
            <td align="center" valign="middle">
                ...
                <asp:ImageButton ID="ImgBtnReservation" runat="server" 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                 <asp:ImageButton ID="imgBtnInterestBox" runat="server" 
                    ImageUrl="~/Images/FangRuYuYueXiangBtn.png" onclick="bt_EquipCar_Click" />
                </td>
        </tr>
    </table>
</asp:Content>
